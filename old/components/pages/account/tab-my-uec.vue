...
<template>
  <p class="dark:text-white/50">
    Add or update personal information for the account. Change your subscription
    options for UEC Theatres communications.
  </p>
  ...
  <u-form>
    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      <u-form-item label="State">
        <u-select v-model:value="informationForm.state" :options="states" />
      </u-form-item>
    </div>
  ...
  <p>
    By clicking "Save Changes", you are indicating that you have read and agree
    to the
