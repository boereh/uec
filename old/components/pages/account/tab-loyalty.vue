...
<template>
  <p class="dark:text-white/50">
    All your Loyalty Rewards cards in one place. You can link, update, or remove
    a linked Loyalty Rewards card. FREE Loyalty Rewards cards can only be
    obtained in-person at the UEC Theatre Box Office with your name, valid email
