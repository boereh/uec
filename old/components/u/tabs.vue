...
<template>
  <div>
    <div class="whitespace-nowrap overflow-hidden">
      <div class="flex overflow-auto">
        <button
          v-for="tab of tabs || []"
          :key="tab.key"
          :class="['px-4 py-2 border-b-2 transition-default', selected === tab.key ? 'border-brand-red text-brand-red' : 'border-transparent']"
    ...
    <div class="bg-light-500 dark:bg-dark-800 border border-light-900 dark:border-dark-500">
      <div
        v-for="tab of tabs || []"
        :key="tab.key"
