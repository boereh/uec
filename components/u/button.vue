...
const types: Record<ButtonTypes, string> = {
  default: 'border border-dark-50 hover:border-brand-red hover:text-brand-red active:border-brand-red-lighter active:text-brand-red-lighter',
  ...
  primary: 'bg-brand-red text-white hover:bg-brand-red-darker active:bg-brand-red-lighter',
  secondary: 'bg-dark-500 dark:bg-light-500 text-brand-red hover:bg-dark-900 hover:dark:bg-light-900 active:bg-dark-50 active:dark:bg-white',
...
<template>
  <component
    ...
    :class="[
      'flex items-center justify-center gap-2 rounded-md transition-all duration-300 select-none shadow-button',
