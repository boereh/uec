...
<template>
    <div class="flex gap-4">
        <button
            :class="[
                'transition duration-300 select-none whitespace-nowrap relative border border-light-900 dark:border-dark-300 box-content',
                rounded ? 'rounded-full' : 'rounded-md',
                size ? sizes[size] : sizes.default,
                value
                    ? 'bg-brand-red border-brand-red'
                    : 'hover:border-light-900 hover:dark:border-dark-50',
            ]"
