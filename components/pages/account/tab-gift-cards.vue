...
<template>
  <p class="dark:text-white/50">
    All your UEC Theatres gift cards in one place. You can link, update, or remove a linked gift card. FREE Loyalty Rewards cards can only be obtained in-person
    at the UEC Theatre Box Office with your name, valid email address and phone number.
  </p>
