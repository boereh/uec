...
const communicationForm = reactive({
    news: user?.user_metadata?.subscribe_news || false,
    showtimes: user?.user_metadata?.subscribe_showtimes || false,
})
...
<template>
    <p class="dark:text-white/50">
        Add or update personal information for the account. Change your
        subscription options for UEC Theatres communications.
    </p>
    ...
    <p>
        By clicking "Save Changes", you are indicating that you have read and
        agree to the
