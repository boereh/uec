...
<template>
  <p class="dark:text-white/50">
    All your Loyalty Rewards cards in one place. You can link, update, or remove a linked Loyalty Rewards card. FREE Loyalty Rewards cards can only be obtained
    in-person at the UEC Theatre Box Office with your name, valid email address and phone number.
  </p>
  ...
  <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
    ...
    >
      ...
      <button
        class="z-1 absolute right-2 bottom-2 p-2 text-md"
        @click=""
      >
