...
const { data: featured } = await useFetch<FeaturedMovie[]>('/api/featured', { method: 'POST' })
  ...
  <u-container>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-1 gap-4">
              <u-form-item label="Theatre">
                <u-select
                  ...
                  :options="Theatres.map((x) => ({ value: x.id, text: x.name }))"
                />
              </u-form-item>
    ...
    <div class="flex <sm:flex-col gap-4 sm:gap-8">
      ...
      <div class="flex-grow">
        ...
        <p>Pick up a Free Loyalty Rewards Card today. Earn valuable points for each purchase. Redeem for FREE soda, FREE popcorn & FREE movie tickets!</p>
    ...
    <div class="flex <sm:flex-col-reverse gap-4 sm:gap-8">
      <div class="flex-grow">
        ...
        <p>
          ESpecial discounts and private viewings are available for parties of 50+. Great for business events, school outings, employee rewards, or any other
          group activity.
        </p>
    ...
    <div class="flex <sm:flex-col gap-4 sm:gap-8">
      ...
      <div class="flex-grow">
        ...
        <p>Give the gift of entertainment! Gift Cards are available online or at your local UEC Theatre.</p>
