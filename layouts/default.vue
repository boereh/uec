...
<template>
    <nav
        class="bg-light-50 dark:bg-dark-900 border-b border-brand-red relative overflow-x-hidden sticky top-0 pl-4 sm:px-8 z-100"
    >
        <div class="max-w-5xl mx-auto h-24 flex gap-4 justify-between">
            <nuxt-link
                class="h-full min-w-fit py-2"
                to="/"
                @click="drawerEnabled = false"
            >
                <svg-logo class="h-full w-fit" />
            </nuxt-link>
            ...
            <div class="md:hidden flex flex-col min-w-42">
                ...
                >
                    ...
                    <button
                        ...
                        :class="[
                            drawerEnabled ? 'bg-brand-red text-white' : '',
                        ]"
                ...
                >
                    <span
                        class="px-2 justify-center items-center flex-grow flex gap-1 h-10 whitespace-nowrap text-white"
                    >
                        <icon
            ...
            <div class="flex flex-col items-end h-full <md:hidden">
                <div
                    class="h-10 flex items-center gap-4 w-full flex-grow <md:hidden"
                >
                    <nuxt-link
                ...
                >
                    <div
                        class="<md:hidden h-10 grid grid-cols-5 w-full whitespace-nowrap text-sm"
                    >
                        <nuxt-link
                            ...
                            :class="[
                                index < links.length - 1
                                    ? 'border-solid border-r border-white/30 hover:border-white/0'
                                    : '',
                            ]"
                            :to="link.to"
                        >
